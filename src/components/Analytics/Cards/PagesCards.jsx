  ...
  const pages = [
    {
      ...
      image: syredu,
      likes: analytics?.syredu[0]?.likes,
      endPoint: "syredu",
      date: analytics?.syredu[0]?.date,
    },
    {
      id: 2,
      title: "بكالوريا سوريا",
      image: bac,
      likes: analytics?.bac[0]?.likes,
      endPoint: "bac",
      date: analytics?.bac[0]?.date,
    },
    {
      id: 3,
      title: "سوريا التعليمية",
      image: syr,
      likes: analytics?.syr[0]?.likes,
      endPoint: "syr",
      date: analytics?.syr[0]?.date,
    },
  ];
